...
in
{
  systemd.tmpfiles.rules = [
    ...
    "d /mnt/storage/media/anime 0755 ${puid} ${pgid} -"
    "d /mnt/storage/media/anime-movies 0755 ${puid} ${pgid} -"
    ...
    "d /mnt/storage/k3s/config/sonarr-anime 0755 root root -"
    "d /mnt/storage/k3s/config/radarr 0755 root root -"
    "d /mnt/storage/k3s/config/radarr-anime 0755 root root -"
