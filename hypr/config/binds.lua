...
-- Multimedia / brightness — submap_universal so they keep working in game mode
local hwOpts = { locked = true, repeating = true, submap_universal = true }
local hwOptsOnce = { locked = true, submap_universal = true }
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+"), hwOpts)
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-"), hwOpts)
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle"), hwOpts)
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"), hwOpts)
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("brightnessctl -e4 -n2 set 5%+"), hwOpts)
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightnessctl -e4 -n2 set 5%-"), hwOpts)

hl.bind("XF86AudioNext", hl.dsp.exec_cmd("playerctl next"), hwOptsOnce)
hl.bind("XF86AudioPause", hl.dsp.exec_cmd("playerctl play-pause"), hwOptsOnce)
hl.bind("XF86AudioPlay", hl.dsp.exec_cmd("playerctl play-pause"), hwOptsOnce)
hl.bind("XF86AudioPrev", hl.dsp.exec_cmd("playerctl previous"), hwOptsOnce)
